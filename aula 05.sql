...
ALTER TABLE T_TESTE_DDL ADD CONSTRAINT PK_TEST DDL PRIMARY KEY (CD_TESTE);
...
ALTER TABLE T_TESTE_DDL DROP COLUMN DS_OB2;

ALTER TABLE T_TESTE_DDL DROP CONSTRAINT SYS_C005413879;
